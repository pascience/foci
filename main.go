...
import (
	...
	"github.com/pascience/wingo/commands"
	"github.com/pascience/wingo/cursors"
	"github.com/pascience/wingo/event"
	"github.com/pascience/wingo/focus"
	"github.com/pascience/wingo/frame"
	"github.com/pascience/wingo/hook"
	"github.com/pascience/wingo/logger"
	"github.com/pascience/wingo/misc"
	"github.com/pascience/wingo/stack"
	"github.com/pascience/wingo/wm"
	"github.com/pascience/wingo/xclient"
)
...
func init() {
	...
	flag.StringVar(&flagConfigDir, "config-dir", flagConfigDir,
		"Override the location of the configuration files. When this\n"+
			...
			"$GOPATH/src/github.com/pascience/wingo/config")
	flag.StringVar(&flagDataDir, "data-dir", flagDataDir,
		"Override the location of the data files (images/fonts). When this\n"+
			...
			"$GOPATH/src/github.com/pascience/wingo/data")
